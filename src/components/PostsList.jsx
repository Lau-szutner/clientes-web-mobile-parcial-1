...
import {
  ...
  query,
  orderBy,
  Timestamp, // Asegurarse de importar Timestamp
        ...
        {posts.map((post) => (
          ...
          >
            ...
            <div className="flex gap-10 my-5 items-center">
              ...
              {/* Aquí debes mostrar la fecha correctamente */}
              {/* Si el post tiene una propiedad "date" que sea Timestamp, se podría formatear */}
